...
stop_loss=-10
take_profit=30
balance=capital_i+flotante
rendimiento=balance/capital_i
up_rsi=90
down_rsi=25
#%%
# =============================================================================
...
baja=0
condicion_up=False
condicion_down=False
for i in range(14,fin):
    rsi_=rsi_fun(df1_precios.iloc[:,2],i,14)
